...
static void demoAutoBuildPath(char *path, int size, const char *name) {
...
qboolean demoFindFreePath(char *path, int size, const char *name) {
	...
	demoAutoBuildPath(path, size, name);
...
void demoAutoSaveLast_f(void) {
	...
	demoAutoBuildPath(lastDemoPath, sizeof(lastDemoPath), DEFAULT_NAME_LAST);
	demoAutoBuildPath(autoDemoPath, sizeof(autoDemoPath), autoDemoName);
